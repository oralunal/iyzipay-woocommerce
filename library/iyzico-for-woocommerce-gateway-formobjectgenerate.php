...
class Iyzico_Checkout_For_WooCommerce_FormObjectGenerate {
    ...
    $user            = wp_get_current_user();
		...
		$iyzico->paymentSource                = 'WOOCOMMERCE|'.WOOCOMMERCE_VERSION.'|CARRERA-3.4.0'.$affiliate;
	...
	public function generateOptionPwi($items,$language,$data,$apiKey,$affiliate) {
		...
		$iyzico->paymentSource                = 'WOOCOMMERCE|'.WOOCOMMERCE_VERSION.'|CARRERA-PWI-3.4.0'.$affiliate;
