...
if (!class_exists('Iyzico_For_WooCommerce')) {
    ...
    class Iyzico_For_WooCommerce
    {
        ...
        protected function __construct()
        {
            ...
            // Blocks Support
            add_action('woocommerce_blocks_loaded', array($this, 'iyzico_woocommerce_blocks_support'));
            add_action('before_woocommerce_init', array($this, 'iyzico_cart_checkout_blocks_compatibility'));
        }
         ...
         * 
         */
        public function iyzico_cart_checkout_blocks_compatibility()
        {
         ...
         * @since 3.2.0
         * @version 1.0.0
         * action: woocommerce_blocks_loaded
         * 
         */
        public function iyzico_woocommerce_blocks_support()
        {
            if (!class_exists('Automattic\WooCommerce\Blocks\Payments\Integrations\AbstractPaymentMethodType')) {
                return;
            }

            include_once IYZICO_PATH . '/library/iyzico-for-woocommerce-blocks.php';

            add_action(
                'woocommerce_blocks_payment_method_type_registration',
                function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
                    $payment_method_registry->register(new Iyzico_For_WooCommerce_Blocks);
                }
            );
        }
        ...
        public function InitIyzicoPaymentGateway()
        {
            ...
            add_action(
                'wp_footer',
                array(
                    'Iyzico_Checkout_For_WooCommerce_Buyer_Protection',
